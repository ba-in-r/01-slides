...
## Instrucciones:
	...
	1.	Copie la ruta de ejecución chunks de código proporcionados en R.
...
```
	...
	4.	Suba su scritp a la plataforma Intu.

## Preguntas:

	1. Construir el grafo: Crea el grafo dirigido y ponderado:
	2. Obtén al menos tres indicadores de centralidad:
	3. Identificar el jugador más influyente
Basado en las métricas anteriores, responde:
	•	¿Quién es el jugador más influyente en la red?
	•	¿Cuál parece actuar como conector entre líneas?
	•	¿Qué jugador parece más periférico?
	4. Visualizar la red
Haz un gráfico que muestre las relaciones entre jugadores, usando:
	•	plot() (básico), o
	•	ggraph() (si desean un resultado más estético).
